...
<section class="related-product-area section_gap_bottom">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="ctg-right">
					<a href="{{ url('todays/offer') }}" target="_blank">
						
						<img class="img-fluid d-block mx-auto" src="{{ asset('frontend/assets/img/category/c6.png') }}" alt="">
					</a>
				</div>
				<br>
				<div class="ctg-right">
					<a href="{{ url('todays/offer') }}" target="_blank">
						...
						<img class="img-fluid d-block mx-auto" src="{{ asset('frontend/assets/img/category/c7.png') }}" alt="">
					</a>
				</div>
			</div>
		</div>
