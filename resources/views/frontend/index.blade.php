			...
			<div class="col-lg-12">
				<div class="active-banner-slider owl-carousel">
					...
					<div class="row single-slide align-items-center d-flex">
						<div class="col-lg-5 col-md-6">
							<div class="banner-content">
								<h1>Affordable Smart Home</h1>
								<p>Smart Home Technology for Every Budget!</p>
								{{-- <p>Bringing Convenience and Efficiency to Your Home.</p> --}}
					...
					<div class="row single-slide">
						...
						<div class="col-lg-7">
							<div class="banner-img">
								<img class="img-fluid" src="{{asset('frontend/assets/img/banner/banner1.png') }}" alt="">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row features-inner">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="single-features">
					...
					<p><strong>Delivery All Over Bangladesh</strong></p>
					<p></p>
				</div>
			</div>
			<!-- single features -->
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="single-features">
					...
					<p><strong>After Sales Service (T&C Applicable)</strong></p>
					<p></p>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-product">
						<a href="{{ url('product/details/'.$product->id) }}">
						    	@php
								$dis_per = round(($product->selling_price - $product->discount_price)/$product->selling_price*100);
							@endphp
							@if ($product->discount_price == NULL)
							
							@else
							<span class="badge badge-danger rounded-pill p-2">{{$dis_per }}%</span>
							@endif
