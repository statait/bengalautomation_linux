			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<form id="GFG" class="row contact_form" action="{{ route('checkout.store') }}" method="POST">
						...
						<div class="col-md-12 form-group">
							<input type="text" name="district_id" class="form-control unicase-form-control text-input" id="district_id" placeholder="District">
							@error('district_id') 
							<span class="text-danger">{{ $message }}</span>
							@enderror 
						</div>
					...
					<div class="col-md-12 form-group">
						<textarea class="form-control" cols="30" rows="5" placeholder="Address" name="notes" required=""></textarea>
						@error('notes') 
							<span class="text-danger">{{ $message }}</span>
						@enderror 
					</div>
				...
				<div class="order_box">
					...
					<div class="single-element-widget mt-30">
						...
						<div class="switch-wrap d-flex justify-content-between">
							...
							<div class="">
								<input name="payment_method" type="radio" id="default-radio" value="cod" checked>
